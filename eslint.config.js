...
export default tseslint.config(
  ...
  //
  // supabase/ runs in Deno, which owns its own fmt and lint — this config
  // cannot resolve its `npm:` specifiers or `Deno` globals, and its .ts files
  // belong to no tsconfig, which projectService reports as an error.
  {
    ignores: [
      "build/",
      ".react-router/",
