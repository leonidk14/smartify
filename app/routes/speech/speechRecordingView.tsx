...
export function SpeechRecordingView({ recording }: SpeechRecordingViewProps) {
  ...
  const isReadOnly = recording.reviewedAt !== null;
      ...
      <Box p={16} pb={110} flex={1}>
        <Stack gap={15}>
          <Box>
            ...
            <MarkedTranscript
              spans={spans}
              onSelectSuggestion={isReadOnly ? undefined : openSheet}
            />
          </Box>
                ...
                {recording.suggestions.map((suggestion) => {
                  ...
                  return (
                    <Group
                      ...
                      py={11}
                      onClick={
                        isReadOnly ? undefined : () => openSheet(suggestion.id)
                      }
                      style={{
